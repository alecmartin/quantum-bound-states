...
/**
 * Constructor to draw the asymmetric well potential
...
define( function( require ) {
  ...
  function AsymmetricWellPlot( potential, valueToX, valueToY, xToValue, yToValue, options ) {
    ...
    potential.wellWidthProperty.link( function() {
      drawWell();
      wellPath.shape = wellShape;
      wellOffsetControl.centerX = valueToX( -potential.wellWidthProperty.value / 2 );
  ...
  return inherit( Node, AsymmetricWellPlot );
} );